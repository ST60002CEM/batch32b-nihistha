...
import '../widget_test/pet_listing_widget/pet_listing_widget_test.mocks.dart';
...
void main(){
  ...
  test('Fetch products ', () async {
    ...
    // Fetch products
    await container.read(petListingViewModelProvider.notifier).getPetListing();
